...
from mindvideo.models.layers.swish import Swish
from mindvideo.models.layers.dropout_dense import DropoutDense
from mindvideo.models.layers.avgpool3d import AvgPool3D
from mindvideo.models.layers.squeeze_excite3d import SqueezeExcite3D
from mindvideo.models.layers.resnet3d import ResNet3D, ResidualBlock3D
...
def x3d_m(num_classes: int = 400,
    ...
    Examples:
        ...
        >>> from mindvision.mindvideo.models import x3d_m
        >>>
        >>> network = x3d_m()
