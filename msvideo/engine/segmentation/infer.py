...
def main(pargs):
    ...
    ann_path = os.path.join(config.data_loader.train.dataset.path, "annotations/instances_valid_sub.json")
    folder = os.path.join(config.data_loader.train.dataset.path, "val/JPEGImages/")
