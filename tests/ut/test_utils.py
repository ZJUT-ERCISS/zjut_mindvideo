...
def test_config():
    ...
    config_path = '/home/shr/mindspore/dabao/zjut_mindvideo/mindvideo/config/x3d/x3d_m.yaml'
...
def test_six_padding():
    from mindvideo.utils.six_padding import six_padding
...
def test_check_param():
    from mindvideo.utils.check_param import check_is_number
    number = 3
...
def test_gaussian():
    from mindvideo.utils.gaussian import gaussian_radius, gaussian2d
    det_size = (3,5)
...
#     from mindvideo.utils.resized_mean import reisze_mean
...
def test_windows():
    from mindvideo.utils.windows import limit_window_size, window_partition
